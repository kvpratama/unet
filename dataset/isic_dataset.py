...
class IsicDataset(Dataset):
    def __init__(self, opt):
        ...
        data_files = sorted(glob.glob(os.path.join("./data", opt.dataset_name, "input/*.*")))
        mask_files = sorted(glob.glob(os.path.join("./data", opt.dataset_name, "gt/*.*")))

        try:
            table_df = pd.read_csv(os.path.dirname(os.path.join("./data", opt.dataset_name, "input")) + '/train_test_split.csv')
            ...
            table_df['test'] = mask
            table_df.to_csv(os.path.dirname(os.path.join("./data", opt.dataset_name, "input")) + '/train_test_split.csv')
